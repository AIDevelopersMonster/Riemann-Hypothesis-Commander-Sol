...
Write-Host "Stability   : E_complex <= 0.10 and rho_complex >= 0.995"
Write-Host "Temporal    : complex Frobenius target score at exact log(m)"
Write-Host "Incremental : blockwise complex residualization against area"

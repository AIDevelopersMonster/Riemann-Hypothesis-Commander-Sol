...
**«Чаепития в аддитивно-мультипликативном мире с Шляпником Sol»** — новая серия «Размышлизмов» о том, какие свойства арифметики принадлежат представлению, какие — структуре, и как меняется симметрия простых при забывании или совместном удержании операций.
...
Рабочее продолжение **HATTER-SOL-02**: редукции совместной структуры `Omega=(+,x)` и количественная потеря/возврат симметрии простых.

...
### FCOA-Z · Классические тени и реконструкция

**«Классическая алгебра как тень одномерной частичной геометрии с переменным разрешением: схлопывание, матричные единицы и реконструкция в FCOA-Z»**  
Zenodo DOI: **[10.5281/zenodo.22179357](https://doi.org/10.5281/zenodo.22179357)**  
GitHub-компаньон: [`delegated/FCOA_Z_SYMMETRIC_LINE/`](delegated/FCOA_Z_SYMMETRIC_LINE/)

Основная цепочка:

`ассоциативное схлопывание -> изоляция корня -> матричные единицы -> финитарная матричная тень -> реконструкция знаковой оси -> no-go по provenance/definedness/terminal attachment`.

Все результаты этой публикации остаются на одной знаковой FCOA-Z оси: размер матрицы не интерпретируется как пространственная размерность.
...
- 30.08.2026 — **FCOA-Z · Классические тени / реконструкция**, Zenodo DOI **10.5281/zenodo.22179357**; одномерная исследовательская линия продолжается.

...
Three results from this direction are strong enough for upstream review.
...
- **Small cases:** arbitrary balanced two-fiber rigidity first appears at `n=4`; balanced tournament rigidity first appears at `n=5` by exhaustive enumeration.
...
Recommend upstream acceptance of U2 and the scope-sharpening content of U3 after independent hostile review. Do not edit G4 from this subordinate branch. If G4 itself survives hostile audit, present it as the elegant **order-derived** two-fiber construction and keep global rigidity-cost statements separate.
# HATTER-SOL-18
# Адаптивная неабелева томография: когда следующее слово выбирается предыдущим наблюдением

**Статус:** рабочий публикационный черновик RU v0.1  
**Ветка:** `research/hatter-sol-18-adaptive-word-tomography`  
**Родитель:** HATTER-SOL-17

## Аннотация

HATTER-SOL-18 продолжает конечную аппаратно-математическую лабораторию
(PSL(2,7)), построенную в HATTER-SOL-17, заменяя фиксированный набор
наблюдателей адаптивной программой опроса.
...
## 1. От фиксированного fingerprint к программе опроса
...
## 3. Теорема об adaptive depth four
...
## 5. Higman trace и canonical lift
...
## 11. Теорема о глобальном query alphabet
...
## 16. Следующие теоремы перед publication freeze

#!/usr/bin/env python3
"""Exact size-9 H18 search on the quotient by query response-partition type.
...
alphabet. A size-9 alphabet therefore chooses seven query identities from the
...
print("H18 exact size-9 partition-type quotient search")
...
if witness is None:
    print("RESULT: no size-9 partition-type multiplicity vector satisfies full H18-06 adaptive contract")
    print("CONSEQUENCE: M1(W4) >= 10")
else:
    print("RESULT: size-9 adaptive witness exists")

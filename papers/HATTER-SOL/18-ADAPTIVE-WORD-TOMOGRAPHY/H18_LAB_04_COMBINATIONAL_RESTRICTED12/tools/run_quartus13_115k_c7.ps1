...
Write-Host "== H18-LAB-04 combinational restricted-12 EP4CE115F29C7 =="
Write-Host "== Matched target against already-characterized H17-LAB-02 115K C7 =="
...
try {
  ...
  $rc = $LASTEXITCODE
  $sw.Stop()
  Write-Host ("H18 LAB04 115K C7 COMPILE ELAPSED: {0:N3} seconds" -f $sw.Elapsed.TotalSeconds)

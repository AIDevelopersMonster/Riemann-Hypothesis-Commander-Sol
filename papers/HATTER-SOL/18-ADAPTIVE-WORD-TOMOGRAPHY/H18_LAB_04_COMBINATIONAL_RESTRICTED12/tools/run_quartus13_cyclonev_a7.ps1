...
$Project = "h18_r12_comb_cv_a7"
New-Item -ItemType Directory -Force $Gen | Out-Null

Write-Host "== H18-LAB-04 combinational restricted-12 Cyclone V =="
Write-Host "== Matched target: 5CEFA7F23C6 =="
...
try {
  ...
  $rc = $LASTEXITCODE
  $sw.Stop()
  Write-Host ("H18 LAB04 CYCLONE V COMPILE ELAPSED: {0:N3} seconds" -f $sw.Elapsed.TotalSeconds)

...
**Status:** publication working draft EN v0.3  
...
The H18-specific contribution is the exact finite integration
...
No priority claim over those fields is made.

## 22. Remaining gates before publication freeze

1. Determine the exact value
   \[
   M_1(W_4)\in\{9,10,11,12\}
   \]
   if this closes before the manuscript freeze.
2. Perform final bibliography verification.
3. Perform final claim/non-claim consistency review.
4. Keep the EP4CE115F29C7 value 26,460 explicitly labelled as a MAP estimate
   unless a separate final-fit utilization line is archived.
5. Assemble synchronized RU/EN publication PDFs after the editorial freeze.

...
Write-Host "== H17-LAB-02 smoke: generate closure-aware frontend =="
...
Write-Host "== H17-LAB-02 smoke: generate ROM-free repair =="
...
$Sim = Join-Path $Build "h17_lab02_smoke_sim"
...
Write-Host "== H17-LAB-02 smoke: compile =="
& iverilog @Sources
if ($LASTEXITCODE -ne 0) { throw "iverilog compile failed" }

Write-Host "== H17-LAB-02 smoke: run exactly one vector =="

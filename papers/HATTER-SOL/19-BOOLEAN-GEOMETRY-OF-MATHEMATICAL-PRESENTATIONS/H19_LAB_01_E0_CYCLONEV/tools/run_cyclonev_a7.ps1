...
$H19 = Resolve-Path (Join-Path $Lab "..")
$Hatter = Resolve-Path (Join-Path $H19 "..")
...
Write-Host "== H19-LAB-01 E0 Cyclone V =="
...
set_global_assignment -name TOP_LEVEL_ENTITY h18_r12_comb_controller
set_global_assignment -name PROJECT_OUTPUT_DIRECTORY output_files
set_global_assignment -name SYSTEMVERILOG_FILE ../../generated/$Mode/psl27_membership_only.sv
set_global_assignment -name SYSTEMVERILOG_FILE ../../generated/$Mode/psl27_member_class_only.sv
set_global_assignment -name SYSTEMVERILOG_FILE ../../generated/$Mode/h18_r12_comb_core.sv
set_global_assignment -name SYSTEMVERILOG_FILE ../../generated/$Mode/h18_r12_comb_controller.sv
...
try {
  ...
  Write-Host ("H19 {0} CYCLONE V COMPILE ELAPSED: {1:N3} seconds" -f $Mode,$sw.Elapsed.TotalSeconds)
  ...
  Write-Host "PASS H19-LAB-01 $Mode on 5CEFA7F23C6"
}
finally {
  Pop-Location
}

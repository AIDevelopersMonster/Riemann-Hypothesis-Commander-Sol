...
\item
  ...
  L\_q(r)\ge\left\lceil\frac{q(r-1)}2\right\rceil; \tag{5} {]}
\item
...
{[} \boxed{\Gamma_a\cup\Gamma_b\text{ is connected}.} \tag{16} {]}
...
{[}
W(P)=\{x\in\mathbb F\_2\^{}\{r-1\}:x\text{ is constant on every block of }P\},
\tag{40} {]}
